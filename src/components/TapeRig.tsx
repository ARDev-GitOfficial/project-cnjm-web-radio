...
export const TapeRig = memo(function TapeRig({ isPlaying }: { isPlaying: boolean }) {
  const vinylSrc = optimizedStaticImageUrl("/assets/glass-ref-vinyl.webp", { width: 900, height: 900, quality: 84 });
  const reelSrc = optimizedStaticImageUrl("/assets/glass-ref-bobina.webp", { width: 360, height: 360, quality: 84 });
  const cassetteSrc = optimizedStaticImageUrl("/assets/glass-ref-fita.webp", { width: 980, quality: 84 });
