...
export const appPrivacyPolicy = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        "Para controle interno, o app pode registrar quando um anuncio foi exibido ou clicado.",
      bullets: [
        "As estatisticas podem incluir identificador do anuncio, tipo de evento, data/hora tecnica e contadores de exibicao ou clique.",
        "Essas estatisticas sao usadas para medir campanhas, evitar erro de exibicao e prestar contas a parceiros.",
        "O app nao precisa identificar nominalmente o ouvinte para registrar exibicao ou clique de banner.",
