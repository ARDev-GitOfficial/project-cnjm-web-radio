...
export function AdImageCropper({ file, onCancel, onApply }: Props) {
  ...
  const applyCrop = async () => {
    ...
    try {
      ...
      await onApply({
        fileName: toPngFileName(file.name),
        contentType: "image/png",
      ...
      setError(error instanceof Error ? error.message : "Não foi possível gerar o PNG final.");
    } finally {
      setIsApplying(false);
    }
  };
        ...
        <div className="image-crop-grid">
          ...
          <div className="image-crop-controls">
            <div>
              ...
              <span>{AD_BANNER_WIDTH} x {AD_BANNER_HEIGHT}px · PNG</span>
