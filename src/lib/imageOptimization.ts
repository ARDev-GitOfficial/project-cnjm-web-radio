...
export function installOptimizedBackgroundImages() {
  ...
  root.style.setProperty(
    ...
    `url("${optimizedStaticImageUrl("/assets/bg-cnjm-landscape-v2.webp", { width: 1600, quality: 76 })}")`,
  );
  root.style.setProperty(
    "--mobile-background-image",
    `url("${optimizedStaticImageUrl("/assets/glass-ref-background-portrait-v2.webp", { width: 920, quality: 74 })}")`,
  );
}
